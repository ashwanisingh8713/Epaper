...
//            canvas.drawRect(pair.first.getRect(), pair.second);
            ...
            float left = pair.first.getRect().left;
            float top = pair.first.getRect().top;
            float right = pair.first.getRect().right;
            float bottom = pair.first.getRect().bottom;

            Log.i("Ashwani", "Red left :: "+left);
            Log.i("Ashwani", "Red top :: "+top);
            Log.i("Ashwani", "Red right :: "+right);
            Log.i("Ashwani", "Red bottom :: "+bottom);


            Path path = new Path();
            path.addRect(left*getScale(), top*getScale(), right*getScale(), bottom*getScale(), Path.Direction.CW);

//            path.addRect(pair.first.getRect(), Path.Direction.CW);
